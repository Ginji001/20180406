const CACHE = "hachiroku-techo-v22";
const ASSETS = ["./about.html", "./privacy.html", "./terms.html", "./", "./index.html?v=22", "./styles.css?v=22", "./app.js?v=22", "./manifest.webmanifest?v=22", "./favicon.svg", "./icon-192.png", "./icon-512.png", "./paper-sheet.pdf", "./google-calendar.js?v=22"];
