const CACHE = "hachiroku-techo-v14";
const ASSETS = ["./", "./index.html?v=14", "./styles.css?v=14", "./app.js?v=14", "./manifest.webmanifest?v=14", "./favicon.svg", "./icon-192.png", "./icon-512.png", "./paper-sheet.pdf"];
