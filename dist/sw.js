const CACHE = "hachiroku-techo-v12";
const ASSETS = ["./", "./index.html?v=12", "./styles.css?v=12", "./app.js?v=12", "./manifest.webmanifest?v=12", "./favicon.svg", "./icon-192.png", "./icon-512.png"];
