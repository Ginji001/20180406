const CACHE = "hachiroku-techo-v13";
const ASSETS = ["./", "./index.html?v=13", "./styles.css?v=13", "./app.js?v=13", "./manifest.webmanifest?v=13", "./favicon.svg", "./icon-192.png", "./icon-512.png"];
